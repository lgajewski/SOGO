...
import pl.edu.agh.sogo.config.oauth2.OAuth2AuthenticationReadConverter;
import pl.edu.agh.sogo.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("pl.edu.agh.sogo.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("pl.edu.agh.sogo.config.dbmigrations");
